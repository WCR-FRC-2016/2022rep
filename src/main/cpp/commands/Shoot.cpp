...
Shoot::Shoot(Shooter* shooter, Elevator* elevator, double frontSpeed, double backSpeed) : m_shooter{shooter}, m_elevator{elevator}, m_frontSpeed{frontSpeed}, m_backSpeed{backSpeed}  {
